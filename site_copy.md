# Azalea Website Demo Copy

This file contains the scrollytelling copy for the two main tabs of the Azalea website. Feel free to edit these to match the brand voice.

---

## 0. Global Elements
**Brand Name:** Azalea Labs
**Consumer Tab Label:** Listen
**Publisher Tab Label:** Create & Distribute

---

## 1. Consumer Tab: The Streaming App
...
- **Body:** Be the first to hear the difference.
- **CTA:** Get Early Access

---

## 2. Publisher Tab: Production & Distribution
...
- **Body:** Ready to bring your catalog to life?
- **CTA:** Contact our Studio Team
