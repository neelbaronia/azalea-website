                    ...
                    <div className="flex items-stretch gap-4 md:gap-6">
                      ...
                      <div className="flex flex-1 min-w-0 flex-col items-start">
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 mt-auto px-3 md:px-4 py-2 bg-[#1DB954] hover:bg-[#1ed760] text-white text-sm md:text-base font-semibold rounded-full transition-colors"
                        >
